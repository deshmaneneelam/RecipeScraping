...
import com.sdet.scraping.utilities.Utils;
	...
	public class PCOS extends Utils{
		...
		public void checkIngredients() throws IOException {
			...
			//Write to excel
			Excel.writeToExcel(allowedRecipes,"RecipesByMorbidity.xlsx","PCOS");
		}
		...
		private static boolean eliminateRecipes(String[] ingredients) {
			ArrayList<String> eliminateList = Utils.eliminatePCOS();
		...
		private static String toAddRecipes(String[] ingredients) {
		    ArrayList<String> toAddList = Utils.AddtoPCOS();
